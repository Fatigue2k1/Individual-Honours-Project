...
# Function to sanitize and process the output from Azure OpenAI
...
# Function to generate code using Azure OpenAI API
def generate_code(prompt1, prompt2, code_type="python"):
    try:
        ...
        ```
        {prompt1} {prompt2}"""
        llm_output = llm.invoke(template)
...
if __name__ == "__main__":
>>>>>>> 46997377aa95b8f442df7f2f8fda77c976b97be0
    main()